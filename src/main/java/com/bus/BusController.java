...
//	User save process
	...
	public String viewallmovie(@ModelAttribute("moviedetails") MovieDetails moviedetails) {
    ...
    List<MovieDetails> allmovies=movieRepo.findAll();
...
//	Login process
    ...
    if(email.equals("admin@gmail.com")&&password.equals("inmakes"))
    {
    	return "addmovie";
    }
    else
